function [is_blackout,relay_outages,MW_lost,p_out,busessep,movie_data] = dcsimsep(ps,br_outages,bus_outages,opt,Intervention)  
...
Intervened = 0;
while t < t_max
    if t > 10 && Intervened == 0
        ps.branch(Intervention,C.br.status) = 0;
        Intervened = 1;
    end
